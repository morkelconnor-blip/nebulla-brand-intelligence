        ...
        <div className="grid gap-12 md:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <nav className="flex flex-col gap-2">
              ...
              <Link to="/nebullaos" className="text-sm text-muted-foreground hover:text-primary transition-colors">NebullaOS</Link>
          ...
          <div className="space-y-4">
            ...
            <nav className="flex flex-col gap-2">
              <a href="mailto:hello@nebulla.agency" className="text-sm text-muted-foreground hover:text-primary transition-colors">
