    ...
    <div className="min-h-screen bg-[#111620] nocturnal-bg">
      ...
      <section className="pt-24 pb-16 md:pt-32 md:pb-24 animate-page-enter">
        <div className="container mx-auto px-6 max-w-3xl">
          <h1 className="font-display text-4xl font-bold tracking-tighter text-slate-100 mb-4">Terms of Service</h1>
          <p className="text-sm text-slate-400 mb-12">Last updated: March 2026</p>

          <div className="space-y-10">
            <div>
              <h2 className="font-display text-2xl font-semibold text-slate-100 mb-4">1. Acceptance of Terms</h2>
            ...
            <div>
              <h2 className="font-display text-2xl font-semibold text-slate-100 mb-4">2. Services</h2>
              <p className="text-slate-400 leading-relaxed">
            ...
            <div>
              <h2 className="font-display text-2xl font-semibold text-slate-100 mb-4">3. Use of the Website</h2>
            ...
            <div>
              <h2 className="font-display text-2xl font-semibold text-slate-100 mb-4">4. Intellectual Property</h2>
              <p className="text-slate-400 leading-relaxed">
            ...
            <div>
              <h2 className="font-display text-2xl font-semibold text-slate-100 mb-4">5. Disclaimers</h2>
              <p className="text-slate-400 leading-relaxed">
            ...
            <div>
              <h2 className="font-display text-2xl font-semibold text-slate-100 mb-4">6. Limitation of Liability</h2>
              <p className="text-slate-400 leading-relaxed">
            ...
            <div>
              <h2 className="font-display text-2xl font-semibold text-slate-100 mb-4">7. Third-Party Links</h2>
              <p className="text-slate-400 leading-relaxed">
            ...
            <div>
              <h2 className="font-display text-2xl font-semibold text-slate-100 mb-4">8. Changes to These Terms</h2>
              <p className="text-slate-400 leading-relaxed">
            ...
            <div>
              <h2 className="font-display text-2xl font-semibold text-slate-100 mb-4">9. Governing Law</h2>
              <p className="text-slate-400 leading-relaxed">
            ...
            <div>
              <h2 className="font-display text-2xl font-semibold text-slate-100 mb-4">10. Contact</h2>
              <p className="text-slate-400 leading-relaxed">
                If you have any questions about these terms, please contact us at{" "}
                <a href="mailto:hello@nebulla.agency" className="text-blue-400 hover:text-blue-300">
