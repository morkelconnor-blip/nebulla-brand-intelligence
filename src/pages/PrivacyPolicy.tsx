    ...
    <div className="min-h-screen bg-[#111620] nocturnal-bg">
      ...
      <section className="pt-24 pb-16 md:pt-32 md:pb-24 animate-page-enter">
        <div className="container mx-auto px-6 max-w-3xl">
          <h1 className="font-display text-4xl font-bold tracking-tighter text-slate-100 mb-4">Privacy Policy</h1>
          <p className="text-sm text-slate-400 mb-12">Last updated: March 2026</p>

          <div className="space-y-10">
            <div>
              <h2 className="font-display text-2xl font-semibold text-slate-100 mb-4">1. Introduction</h2>
            ...
            <div>
              <h2 className="font-display text-2xl font-semibold text-slate-100 mb-4">2. Information We Collect</h2>
            ...
            <div>
              <h2 className="font-display text-2xl font-semibold text-slate-100 mb-4">3. How We Use Your Information</h2>
              <ul className="list-disc list-inside space-y-2 text-slate-400">
            ...
            <div>
              <h2 className="font-display text-2xl font-semibold text-slate-100 mb-4">5. Data Retention</h2>
              <p className="text-slate-400 leading-relaxed">
            ...
            <div>
              <h2 className="font-display text-2xl font-semibold text-slate-100 mb-4">6. Your Rights</h2>
              <p className="text-slate-400 leading-relaxed">
            ...
            <div>
              <h2 className="font-display text-2xl font-semibold text-slate-100 mb-4">7. Cookies</h2>
              <p className="text-slate-400 leading-relaxed">
            ...
            <div>
              <h2 className="font-display text-2xl font-semibold text-slate-100 mb-4">8. Changes to This Policy</h2>
              <p className="text-slate-400 leading-relaxed">
            ...
            <div>
              <h2 className="font-display text-2xl font-semibold text-slate-100 mb-4">9. Contact</h2>
              <p className="text-slate-400 leading-relaxed">
